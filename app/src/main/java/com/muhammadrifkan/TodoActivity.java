...
import com.muhammadrifkan.connector.CustomCursorConnector;
...
public class TodoActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private void setupListView() {
        ...
        CustomCursorConnector customCursorAdapter = new CustomCursorConnector(this, cursor, 1);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long I) {
        ...
        Intent idpinjam = new Intent(TodoActivity.this, AddTodoActivity.class);
