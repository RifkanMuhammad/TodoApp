...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String database_name = "db_personal";
    public static final String tabel_name = "tabel_todo";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + tabel_name + "(" + row_id + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + row_judul + " TEXT," + row_detail + " TEXT," + row_tanggal + " TEXT," + row_status + " TEXT)";
        db.execSQL(query);
    }
